-- Fix: drop and recreate diet tables with correct column names
-- Run this manually in MySQL if tbl_dietas has wrong column names
...
CREATE TABLE tbl_dietas (
    ...
    CONSTRAINT fk_dieta_paciente
        FOREIGN KEY (paciente_id) REFERENCES tbl_pacientes(id) ON DELETE CASCADE,
...
CREATE TABLE tbl_refeicoes (
    ...
    CONSTRAINT fk_refeicao_dieta
        FOREIGN KEY (dieta_id) REFERENCES tbl_dietas(id) ON DELETE CASCADE,
...
CREATE TABLE tbl_refeicao_opcoes (
    ...
    CONSTRAINT fk_opcao_refeicao
        FOREIGN KEY (refeicao_id) REFERENCES tbl_refeicoes(id) ON DELETE CASCADE,
...
CREATE TABLE tbl_alimentos_refeicao (
    ...
    CONSTRAINT fk_alimento_opcao
        FOREIGN KEY (opcao_id) REFERENCES tbl_refeicao_opcoes(id) ON DELETE CASCADE,
