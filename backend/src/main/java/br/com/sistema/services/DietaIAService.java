...
public class DietaIAService {
    ...
    private String construirPromptUsuario(Paciente paciente, AvaliacaoFisica avaliacao,
        ...
        sb.append("- AO_ACORDAR: 0 kcal\n");
        sb.append("- Demais ").append(refeicoesSemAcordar)
          .append(" refeicoes: ~").append(kcalPorRefeicao).append(" kcal cada (opcao 1 e opcao 2 separadamente)\n");
